...
# Write a default file with url mode
...
# Write an override file that switches from url mode to git mode
...
# Verify that the override switched to git mode
...
foreach(expected_arg IN ITEMS GIT_REPOSITORY GIT_TAG)
  ...
  if(arg_index EQUAL -1)
    message(FATAL_ERROR "CPM args should contain '${expected_arg}' after override to git mode.\nGot: ${cpm_args}"
    )
  endif()
endforeach()
...
foreach(unexpected_arg IN ITEMS URL URL_HASH)
  ...
  if(NOT arg_index EQUAL -1)
    message(FATAL_ERROR "CPM args should NOT contain '${unexpected_arg}' after override to git mode.\nGot: ${cpm_args}"
    )
  endif()
endforeach()
